...
nesma_base64 = get_base64_of_bin_file("assets/nesma.png")
ivy_base64 = get_base64_of_bin_file("assets/Ivy Logo copy.png")
...
st.markdown(
    ...
    <div class="header-container">
      ...
      <div class="header-logo">
         <img src="data:image/png;base64,{nesma_base64}" alt="Nesma Logo">
      </div>
      <div class="header-logo">
         <img src="data:image/png;base64,{ivy_base64}" alt="Ivy Logo">
      </div>
    </div>
    """,
    unsafe_allow_html=True
